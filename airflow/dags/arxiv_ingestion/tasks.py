...
def create_opensearch_placeholders(**context):
    ...
    Placeholder until OpenSearch indexing is wired:
    1. Read papers stored by the fetch task
    2. Record how many documents are ready to index
    """
    ...
    try:
        ...
        placeholder_results = {
            ...
            "message": f"{papers_stored} papers ready for OpenSearch indexing",
        }
